...
public class PageTest {
	...
	public void testIsPreviousPageAvailable() {
		...
		Page<Object> pageWhichStartsAtNumberOfElements = new Page<>(list, NUMBER_OF_ELEMENTS, NUMBER_OF_ELEMENTS, TOTAL_NUMBER_OF_ELEMENTS);
	...
	public void testIsNextPageAvailable() {
		Page<Object> pageWhichStartsAt0 = new Page<>(list, 0, NUMBER_OF_ELEMENTS, TOTAL_NUMBER_OF_ELEMENTS);
		Page<Object> pageWhichStartsAtTotalNumberOfElementsMinusElementsPerPage = new Page<>(list, TOTAL_NUMBER_OF_ELEMENTS - NUMBER_OF_ELEMENTS, NUMBER_OF_ELEMENTS, TOTAL_NUMBER_OF_ELEMENTS);
		Page<Object> pageWhichStartsAtTotalNumberOfElementsMinusElementsPerPagePlus1 = new Page<>(list, TOTAL_NUMBER_OF_ELEMENTS - (NUMBER_OF_ELEMENTS + 1), NUMBER_OF_ELEMENTS, TOTAL_NUMBER_OF_ELEMENTS);
	...
	public void testGetPreviousPageOffset() {
		Page<Object> pageWhichStartsAtNumberOfElements = new Page<>(list, NUMBER_OF_ELEMENTS, NUMBER_OF_ELEMENTS, TOTAL_NUMBER_OF_ELEMENTS);
		Page<Object> pageWhichStartsAtNumberOfElementsPlusOne = new Page<>(list, NUMBER_OF_ELEMENTS + 1, NUMBER_OF_ELEMENTS, TOTAL_NUMBER_OF_ELEMENTS);
		Page<Object> pageWhichStartsAt1 = new Page<>(list, 1, NUMBER_OF_ELEMENTS, TOTAL_NUMBER_OF_ELEMENTS);
